...
- AI、财经继续由 Totemora 现有服务承担。reminder 已由 migration 12、独立 Repository/Application Service、Operator API、Web 案卷、周期 Runner 与可重复 SQLite 快照导入器接管；deals、forwarded 和周期内容在各自领域实现完成前保持显式未提供，不通过恢复旧项目填补空档。
