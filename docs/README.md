...
当前提供 CLI/TUI、本地 Web Gateway 和 MCP 三个主要入口，并以 Telegram、Bark 承接受控通信与通知。Web 已覆盖任务大厅、证据台、成员营帐、火种与资产、AI / 财经情报、内容工坊、Skill 浏览和审批；`totemora run` 与 `onboarding-exam` 仍保留直接创建本地 Runtime 的兼容入口，尚未迁入 Gateway。
